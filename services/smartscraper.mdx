...
<Note>
Try SmartScraper instantly in our [interactive playground](https://dashboard.scrapegraphai.com/) 
</Note>
...
- Parameters like `number_of_scrolls`, `total_pages`, `render_heavy_js`, and `stealth` are not applicable when using Markdown content
</Note>
</Accordion>
