...
<Note>
Try Crawl instantly in our [interactive playground](https://dashboard.scrapegraphai.com/) 
</Note>
...
import { crawlStart, crawlStatus } from 'scrapegraph-js';

const apiKey = 'your-api-key';

const response = await crawlStart(apiKey, {
