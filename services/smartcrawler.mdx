...
<Note>
Try SmartCrawler instantly in our [interactive playground](https://scrapegrphai.com/dashboard) 
</Note>
...
1. Configure your webhook secret in the [dashboard](https://scrapegrphai.com/dashboard)
...
<Card title="Ready to Start Crawling?" icon="rocket" href="https://scrapegrphai.com/dashboard">
