...
<Note>
Try Search instantly in our [interactive playground](https://dashboard.scrapegraphai.com/) 
</Note>
...
| num_results | int | No | Number of search results to return. |
...
const response = await search('your-api-key', {
  query: 'Latest AI developments 2024',
  num_results: 10,
