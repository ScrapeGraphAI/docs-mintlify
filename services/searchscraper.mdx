...
<Note>
Try SearchScraper instantly in our [interactive playground](https://scrapegrphai.com/dashboard) 
</Note>
...
<b>How to use:</b> Set <code>num_results</code> and <code>extraction_mode</code> in your request.
