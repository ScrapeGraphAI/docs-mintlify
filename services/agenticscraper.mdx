...
<Note>
Try it instantly in our [interactive playground](https://scrapegrphai.com/dashboard) – no coding required!
</Note>
...
const response = await agenticScraper(apiKey, {
  url: 'https://scrapegrphai.com/dashboard',
  steps: [
...
```bash CLI
# Basic scraping without AI extraction
just-scrape agentic-scraper https://scrapegrphai.com/dashboard \
...
<Card title="Ready to try?" icon="rocket" href="https://scrapegrphai.com/dashboard">
