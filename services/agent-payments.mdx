...
Payments settle over [InFlow](https://inflowpay.ai) using the `inflow` method (USDC). The
`402` challenge advertises it in the `WWW-Authenticate: Payment` header; pay it with the
InFlow CLI or SDK.
