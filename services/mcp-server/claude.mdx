...
Restart Claude Desktop after saving the configuration. The first connection starts the OAuth login and opens a browser window; choose **Continue with Google** and sign in with the Google account associated with your ScrapeGraphAI account.

After authentication, test the connection by asking Claude to run the `credits` tool.
