...
You'll need a ScrapeGraph API key to use the MCP server. Get one from the [ScrapeGraph Dashboard](https://scrapegrphai.com/dashboard) if you haven't already.
