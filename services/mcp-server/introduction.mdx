...
The ScrapeGraphAI MCP Server is a production-ready Model Context Protocol (MCP) server that connects Large Language Models (LLMs) to the ScrapeGraph AI API. It enables AI assistants like Claude to perform AI-powered web scraping, research, and crawling directly through natural language interactions.
...
<Steps>
  ...
  <Step title="Choose Your Client">
    Use <a href="/services/mcp-server/claude">Claude Desktop</a> or another MCP-compatible client
  </Step>
...
This requires no local installation and works seamlessly with Claude Desktop. See the setup guide above for configuration details.
...
<Card title="Ready to Start?" icon="rocket" href="/services/mcp-server/claude">
  Configure Claude Desktop and start scraping with AI!
</Card>
