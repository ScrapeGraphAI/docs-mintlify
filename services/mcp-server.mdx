...
A Model Context Protocol (MCP) server implementation that integrates ScrapeGraphAPI for web scraping capabilities. Our MCP server is open-source and available on GitHub.
...
[Install with NPX in VS Code](vscode://install-extension/ms-vscode.vscode-json) [Install with NPX in VS Code Insiders](vscode-insiders://install-extension/ms-vscode.vscode-json)
