...
<Note>
Try Markdownify instantly in our [interactive playground](https://dashboard.scrapegraphai.com/) 
</Note>
...
| mock | boolean | No | Optional parameter to enable mock mode. When set to true, the request will return mock data instead of performing an actual conversion. Useful for testing and development. Default: false |
