...
Orthogonal hosts an MCP server at `https://mcp.orth.sh` so Claude, OpenClaw, or any MCP-compatible client can call ScrapeGraph directly without writing glue code. Register it in your client's MCP config:
