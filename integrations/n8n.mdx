...
**Scrape**, **Extract**, **Search**, **Crawl → Start**, and **Monitor → Create / Update** also expose a **Fetch Config** dropdown — eight knobs (mode, stealth, country, wait, timeout, scrolls, headers, cookies) for hard-to-fetch pages. See [Fetch Config](#fetch-config) below.
