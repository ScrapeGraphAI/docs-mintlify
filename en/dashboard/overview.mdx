...
The [ScrapeGraphAI dashboard](https://dashboard.scrapegraphai.com) is your central hub for managing all your web scraping operations. Here you can monitor your usage, start new jobs, and manage your account settings.
...
- **Service-specific metrics**: Track usage for SmartScraper, LocalScraper, and Markdownify separately
