...
<Note>
Try it yourself in our [News Research Agent Notebook](https://github.com/ScrapeGraphAI/scrapegraph-sdk/blob/main/cookbook/research_agent_scrapegraph_langgraph_tavily.ipynb)
</Note>
