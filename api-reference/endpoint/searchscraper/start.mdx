...
<ParamField body="mock" type="boolean">
  Optional parameter to enable mock mode. When set to true, the request will return mock data instead of performing an actual search. Useful for testing and development.
...
<ParamField body="time_range" type="string">
  Optional parameter to filter search results by date range. Controls how recent the search results should be. This is useful for finding recent news, updates, or time-sensitive information.
