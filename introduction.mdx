...
ScrapeGraphAI is a powerful suite of AI-driven web scraping tools designed to extract structured data from websites and HTML content. Our platform combines advanced machine learning with robust scraping capabilities to deliver accurate, reliable data extraction for any scale.
...
<CardGroup cols={2}>
  ...
  <Card title="Services" icon="gears" href="/services/smartscraper">
    Explore our core services: SmartScraper, LocalScraper, and Markdownify
  </Card>
